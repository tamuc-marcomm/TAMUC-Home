...
(function(jQuery, undefined) {
        ...
        container.find('>ul:first >li').each(function(j) {
            ...
            if (li.data('link') != undefined) {
                ...
                if (link == "slide") {
                    ...
                    linktoslide = "no";
                    li.append('<div class="tp-caption sft slidelink" style="z-index:' + zindex + ';" data-x="0" data-y="0" data-linktoslide="' + linktoslide + '" data-start="0"><a target="' + target + '" href="' + link + '"  title="' + dtitle + '"><div></div></a></div>');
                }
    ...
    function countDown(container, opt) {
        ...
        if (opt.slideamount > 1 && !(opt.stopAfterLoops == 0 && opt.stopAtSlide == 1)) {
            ...
            var videoPlay = container.find('>ul >li').find('video').on("playing");
            if(videoPlay[0].paused == false){
                pauseSlider();
            }
        }
    }
